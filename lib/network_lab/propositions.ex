defmodule NetworkLab.Propositions do
    
    alias NetworkLab.Propositions.Proposition
    ...
    def list_propositions() do
        [
            ...
            # %Proposition{
            #     id: 17,
            #     title: "Europeans leave cities during health crisis",
            #     true: "The European elite has been reported to take little precaution against spreading the Corona virus locally as they flee cities for their second homes in rural communities",
            #     false: "Europeans of all income levels have been staying in place and taking strict precautions against potentially spreading the Corona virus in local communities",
            #     post_is_false: false,
            #     post_intended_as_liberal: false,
            # },
            # %Proposition{
            ...
            # %Proposition{
            #     id: 20,
            #     title: "Control measures against the Corona outbreak",
            #     true: "International studies confirm the effectiveness of strict governmental control measures to contain the Covid-19 epidemic in China",
            #     false: "There's no conclusive evidence that limiting individual freedoms effectively contained the Covid-19 epidemic in China",
            #     post_is_false: false,
            #     post_intended_as_liberal: true,
            # },
            %Proposition{
            ...
            # %Proposition{
            #     id: 48,
            #     title: "Approval with government response to Covid-19",
            #     true: "In late March 2020, only 12% of US survey respondents perceived the government reaction to the Covid-19 outbreak to be sufficient. In comparison, approval rates in Germany were at 60% and in Sweden they were at 65%",
            #     false: "In late March 2020, most Americans perceived the government reaction to the Covid-19 outbreak to be appropriate. In comparison, liberal European countries have very low approval rates",
            #     post_is_false: false,
            #     post_intended_as_liberal: true,
            # },
            # %Proposition{
    ...
    def get_proposition(id) do
        Enum.find(list_propositions(), nil, fn p -> p.id == id end)
    end
